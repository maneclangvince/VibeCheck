...
let combinedPool = [];
if (typeof mediumGlobalSongs !== 'undefined') combinedPool = [...combinedPool, ...mediumGlobalSongs];
if (typeof mediumLocalSongs !== 'undefined') combinedPool = [...combinedPool, ...mediumLocalSongs];
...
const startTimer = () => {
    ...
    const timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            ...
            window.location.href = "medium-times-up.html";
        }
    }, 1000);
};
