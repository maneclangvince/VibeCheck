...
let combinedPool = [];
if (typeof hardGlobalSongs !== 'undefined') combinedPool = [...combinedPool, ...hardGlobalSongs];
if (typeof hardLocalSongs !== 'undefined') combinedPool = [...combinedPool, ...hardLocalSongs];
...
const startTimer = () => {
    ...
    const timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            ...
            window.location.href = "hard-times-up.html";
        }
    }, 1000);
};
